...
import type { PlayerProgress as _PlayerProgress } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getNarration(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getNarration(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProgress(arg0: string): Promise<PlayerProgress | null> {
        if (this.processError) {
            try {
    ...
    async saveProgress(arg0: string, arg1: PlayerProgress): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PlayerProgress]): PlayerProgress | null {
